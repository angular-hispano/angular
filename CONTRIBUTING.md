...
No abras *issues* para preguntas de soporte general ya que queremos mantener los *issues* de GitHub para reporte de *bugs* y solitud de funcionalidades.
...
Una reproducción mínima nos permite confirmar rápidamente un error (o señalar un problema de código), así también confirmar que estamos solucionando el problema correcto.
...
El contenido del mensaje del _commit_ debería contener:
