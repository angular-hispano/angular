...
[Web workers](https://developer.mozilla.org/en-US/docs/Web/API/Web_Workers_API) le permiten ejecutar cálculos intensivos de CPU en un subproceso en segundo plano,
