...
Though [template expressions](guide/interpolation#expresiones-de-plantilla) shouldn't have [side effects](guide/property-binding#avoid-side-effects), template
