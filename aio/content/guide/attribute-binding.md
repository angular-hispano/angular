...
Luego establece el valor del atributo, utilizando una expresión que se resuelve en una cadena, o elimina el atributo cuando la expresión se resuelva en `null`.
